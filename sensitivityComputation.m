...
dhdX = grad_h_X_fcn(X, Xref, k_vec, theta_r_dot, theta_r_2dot, omega_r_integ, param(2), param(1));
dhdX = full(dhdX);

dhdtheta = grad_h_theta_fcn(X, Xref, k_vec, theta_r_dot, theta_r_2dot, omega_r_integ, param(2), param(1));
