...
function [dXdphi,dudphi] = sensitivityComputation(dxdtheta_current, X, Xref, theta_r_dot, theta_r_2dot, theta_r_integ, u, param, k_vec, dt, theta_l_integ)
...
dhdX = grad_h_X_fcn(X, Xref, k_vec, theta_r_dot, theta_r_2dot, theta_r_integ, param(2), param(1), dt, theta_l_integ);
dhdX = full(dhdX);

dhdtheta = grad_h_theta_fcn(X, Xref, k_vec, theta_r_dot, theta_r_2dot, theta_r_integ, param(2), param(1), dt, theta_l_integ);
